# Agent Stock Brief API 优化后输出

- 调用时间：2026-06-24 22:48:24 +08:00
- 请求地址：`http://127.0.0.1:18080/api/agent/stock-brief?code=603063`
- 股票代码：`603063`
- 接口：`/api/agent/stock-brief`
- 本版已移除：`industry`、`quote.time`、`insideDish`、`outerDisc`。
- 本版已增加：`amountText` 和财务中文单位字段。
...
```json
{
    ...
    "data":  {
                 ...
                 "quote":  {
                               ...
                               "amount":  1100208768,
                               "amountText":  "11.00亿元",
                               "text":  "现价50.15，涨跌幅2.96%，成交额11.00亿元"
                           },
                 "finance":  {
